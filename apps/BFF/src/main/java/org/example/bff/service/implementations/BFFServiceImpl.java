...
public class BFFServiceImpl implements BFFService {
    ...
    private BackendGraphQL backendGraphQL;
    ...
    public ResponseEntity<?> processRequest(final RequestModel request, final String language) {
        ...
        final String graphQlSchema = backendGraphQL.fetchGraphQLSchema();
        final LLMResponse llmResponse = llmRequest.generateGraphQLQuery(graphQlSchema, request.getTextPrompt(), language,
                request.getContext(), request.getLlmModel(), request.isShouldCallRealLLM(), request.isReturnLLMResponse());
        ...
        return switch (llmResponse.getStatus()) {
            case OK -> {
                ...
                final Object backendResponse = backendGraphQL.queryGraphQLServer(llmResponse.getMessage());
